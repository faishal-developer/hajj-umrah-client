...
import { Lock, Mail, Moon, Sparkles, ArrowRight, Loader2 } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto py-8 sm:py-12 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-slate-500 max-w-xs mx-auto">
          Sign in to view your bookings, check seat reservations, and manage installments.
        </p>
      </div>

      <Card className="border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
        <div className="h-1.5 w-full bg-gradient-to-r from-emerald-600 to-amber-500" />
        <CardHeader className="pb-4">
          <CardTitle className="text-base">Pilgrim Sign In</CardTitle>
        </CardHeader>
